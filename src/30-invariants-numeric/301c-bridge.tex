...
Hilden, Montesinos, Tejada, Toro \cite{hilden2012} klasyfikują wszystkie trzymostowe węzły przy użyciu tak zwanej reprezentacji motylkowej, podobnej do wyniku Schuberta z~sekcji \ref{sub:twobridge}.
...
Murasugi \cite{murasugi1988} przypuszcza, że dla splotów o~$\mu$~ogniwach zachodzi nierówność $\crossing L + \mu - 1 \ge 3 \bridge L - 3$, przedstawia jednocześnie dowód jej szczególnego przypadku, dla alternujących splotów algebraicznych.
\index[persons]{Murasugi, Kunio}%
...
Liczba mostowa ma też zaskakującą interpretację w~geometrii różniczkowej.
Całkowitą krzywizną gładkiej krzywej zamkniętej $\gamma$ nazywamy całkę $\int_\gamma \kappa \, ds$ z~jej krzywizny względem długości łuku.
Fenchel wiedział, że dla każdej krzywej zamkniętej wynosi ona co najmniej $2\pi$, a~sam okrąg pokazuje, że więcej powiedzieć się nie da.
\index[persons]{Fenchel, Werner}%

\begin{theorem}[Fáry, Milnor]
\index{twierdzenie!Fáry'ego-Milnora}%
\index[persons]{Fáry, István}%
\index[persons]{Milnor, John}%
    Jeżeli gładka krzywa zamknięta $\gamma$ przedstawia nietrywialny węzeł, to $\int_\gamma \kappa \, ds > 4\pi$.
\end{theorem}

Twierdzenie udowodnili niezależnie Fáry \cite{fary1949} i~Milnor \cite{milnor1950}, ten drugi jeszcze jako student.
Milnor pokazał więcej: kres dolny całkowitej krzywizny krzywych przedstawiających węzeł $K$ wynosi dokładnie $2\pi \bridge K$ i~nie jest osiągany dla nietrywialnych węzłów.
Twierdzenie Fáry'ego-Milnora wynika stąd natychmiast, ponieważ nietrywialne węzły mają co najmniej dwa mosty.
