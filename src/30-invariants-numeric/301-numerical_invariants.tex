...
\input{30-invariants-numeric/301h-triple}
...
\begin{enumerate}
    \item między indeksem skrzyżowaniowym i genusem \cite[s. 142]{livingston1993},
    \item między liczbą gordyjską i sygnaturą \cite[s. 142]{livingston1993},
    \item między indeksem potrójnych skrzyżowań i~genusem kanonicznym \cite{jablonowski2020},
    \item między całkowitą krzywizną i~liczbą mostową \cite{milnor1950}.
\end{enumerate}
