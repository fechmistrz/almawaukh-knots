...
Nie wiadomo nawet, czy liczba gordyjska jest obliczalna, to znaczy czy istnieje algorytm, który dla dowolnego diagramu węzła $K$ wyznaczy $\unknotting K$ (indeks skrzyżowaniowy jest obliczalny).
Nie znamy nawet algorytmu rozstrzygającego, czy $\unknotting K = 1$ \cite[problem 1.80]{baykur2026}.
Dla splotów rozważa się też liczbę rozplatania, czyli najmniejszą liczbę zmian skrzyżowań prowadzących do niesplotu, oraz liczbę rozszczepiającą, czyli najmniejszą liczbę zmian prowadzących do splotu rozszczepialnego.
Wiadomo, że wyznaczenie liczby rozplatania jest problemem NP-trudnym (de Mesmay, Rieck, Sedgwick, Tancer \cite{demesmay2021}; Koenig, Tsvietkova \cite{koenig2021}).
\index[persons]{Mesmay, Arnaud@de Mesmay, Arnaud}%
\index[persons]{Rieck, Yoav}%
\index[persons]{Sedgwick, Eric}%
\index[persons]{Tancer, Martin}%
\index[persons]{Koenig, Dale}%
\index[persons]{Tsvietkova, Anastasiia}%
Lackenby \cite{lackenbyb2021} rozstrzygnął, czy liczba rozszczepiająca wynosi $1$, dla dużej klasy splotów.
