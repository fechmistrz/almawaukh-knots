...
Encyklopedia Wolfram Mathworld plecie farmazony, że dokładnie jeden węzeł pierwszy do 10 skrzyżowań ma liczbę patykową równą 14: jest to $10_{84}$, dokładnie pięć ma liczbę patykową równą 13: $10_{39}$, $10_{64}$, $10_{73}$, $10_{76}$, $10_{80}$, a liczba patykowa pozostałych nie przekracza 12.
...
Wkrótce wynik został poprawiony przez samego Jina, który w pracy \cite{jin1997} znalazł dokładne wartości dla niektórych węzłów.
...
W~tym samym roku Huh, No, Oh \cite{huh2011b} poprawili też wynik McCabe: jeśli $K$ jest węzłem lub splotem dwumostowym o~co najmniej sześciu skrzyżowaniach, to $\stick K \le \crossing K + 2$.
\index[persons]{Huh, Youngsik}%
\index[persons]{No, Sungjong}%
\index[persons]{Oh, Seungsang}%
