...
Murasugi podał dwa warunki, które musi spełniać węzeł o~okresie $n = p^r$, gdzie $p$ jest liczbą pierwszą.
...
\label{prp:murasugi_periodic}%
    ...
    \begin{equation}
        \alexander_K(t) \equiv \pm t^k \alexander_J(t)^n \left(1 + t + t^2 + \ldots + t^{\lambda - 1}\right)^{n-1} \mod p.
    \end{equation}
\end{proposition}
