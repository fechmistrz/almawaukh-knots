...
\label{two_sums_of_two_trefoils}%
    ...
    \item \emph{składniki $K_1, K_2$ muszą być węzłami, nie splotami}.
...
Estetyczny rysunek uzasadniający tezę znajdziemy u~Burdego, Zieschanga \cite[s. 98]{burde2014}.
...
\index{suma paskowa}%
\index{hiperboliczna transformacja splotu}%
\index{fuzja splotu}%
