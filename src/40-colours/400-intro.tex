...
Dlatego teraz wprowadzimy 3-kolorowanie, z którym nie dość, że będziemy odróżniać pewne węzły od niewęzła, to jeszcze odróżnimy te węzły od siebie!
...
Często można spotkać się też z trójkolorowalnością Foxa, szczególnie w anglojęzycznych materiałach, ale my nie czujemy potrzeby używania długiej nazwy.
...
\begin{comment}
    ...
    \]
\end{comment}
    Ponownie wykonanie ruchu Reidemeistera nie zmienia kolorów dolnych włókien.
\end{proof}
...
\label{prp:links_colouring_like_a_lot}%
    Każdy splot o co najmniej dwóch ogniwach koloruje się modulo dwa.
\end{proposition}
