...
O wielu niezmiennikach węzłów złożonych podejrzewamy albo wiemy, że wyrażają się w terminach mniejszych węzłów pierwszych, oprócz wspomnianej tu liczby kolorowań mamy hipotezę \ref{con:crossing_additive}, dawniej także hipotezę \ref{conjecture_unknotting_additive} (obaloną w~2025 roku), nienazwane oszacowanie na stronie \pageref{stick_bounded_factors}, fakty \ref{lem:det_multiplicativ}, \ref{prp:alexander_multiplicative}, \ref{prp:homfly_and_shraps}, \ref{prp:genus_of_sum}, \ref{prp:signature_additive}, \ref{cor:arf_adds}.
