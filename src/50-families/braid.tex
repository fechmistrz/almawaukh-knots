...
\index{grupa!warkoczy}%
    ...
    \begin{align*}
        \psi_1(d, t) & = (d, t/2) \\
        \psi_2(d, t) & = (d, \frac{1}{2} (t+1))
    \end{align*}
    Klasy abstrakcji warkoczy z~mnożeniem danym wzorem $z_1 z_2 = \psi_1(z_1) \cup \psi_2(z_2)$ tworzą grupę warkoczy $B_n$.
...
\index[persons]{Bohnenblust, Frederic}%
...
Patrz też do książki Birman \cite{birman1974} albo do \cite[s. 164]{burde2014}.
...
Patrz też \cite[s. 170]{burde2014}. % gdyby było potrzeba wskazać gdzieś poważne źródło definicji
...
Burde, Zieschang \cite[s. 172]{burde2014} podają to samo stwierdzenie z $n$ zamiast $2$ w wykładniku.
