...
Pierwsi studiowali je Bankwitz, Schumann \cite{bankwitz1934} w~1934 roku jako \emph{Viergeflechte}; wyjaśnienie czemu podają Burde, Zieschang, Heusener \cite[s. 25, 213]{burde2014}.
...
Parę względnie pierwszych liczb $(\alpha, \beta)$ nazywamy typem węzła dwumostowego; $\alpha$ jest torsją, zaś $\beta$ indeksem skrzyżowaniowym (\cite[s. 210]{burde2014}).
...
\index{soczewka|see {przestrzeń soczewkowa}}%
    Burde, Zieschang \cite[s. 212]{burde2014} wspominają tu prace Reidemeistera \cite{reidemeister1935}, Brody'ego \cite{brody1960} oraz Turajewa \cite{turaev2001}.

    Dowód mocnej wersji znajduje się u Schuberta \cite{schubert1956}, a zapewne także Murasugiego \cite[s. 158]{murasugi1996}.
...
Mimo to potrafimy dokładnie zliczyć węzły dwumostowe (czyli wymierne) dla danej liczby skrzyżowań -- ciąg \href{https://oeis.org/A018240}{A018240} w OEIS.
Znamy też, ile spośród nich ma liczbę gordyjską równą 1 (ciąg \href{https://oeis.org/A078477}{A078477}) oraz ile ma sygnaturę zero (ciąg \href{https://oeis.org/A078478}{A078478}).
Trzy ostatnie ciągi spełniają proste rekurencje lub ich funkcje tworzące mają ładną, zwartą postać.
