...
Kinoshita, Terasaka \cite{kinoshita1957} zdefiniowali nieskończoną rodzinę węzłów, której pierwszym wyrazem jest węzeł $11n_{42}$ (i wszystkie mają trywialny wielomian Alexandera).
...
Hipoteza \ref{conjecture_unknotting_additive} została od tego czasu obalona (fakt \ref{prp:unknotting_not_additive}), natomiast niezmienniczość liczby gordyjskiej względem mutacji pozostaje otwarta \cite[problem 1.3]{baykur2026}.
% TODO: sprawdzić w~K2 (problem 1.69), w~którą stronę biegnie implikacja między tymi dwiema hipotezami: skoro addytywność jest fałszywa, a~mutacje wciąż otwarte, zdanie o~,,wynikałaby z niego'' wyżej wymaga poprawienia
