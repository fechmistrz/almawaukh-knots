...
Później Rasmussen \cite{rasmussen2010} podał inny dowód, który nie wykorzystuje już cechowania (\emph{gauge theory}), tylko homologię Chowanowa (niezmiennik Rasmussena opisujemy krótko w~sekcji~\ref{sec:khovanov}).
...
Burde, Zieschang, Heusener \cite[s. 63]{burde2014} prezentują ciekawy dowód z~komutantem $\mathfrak{Z} = G/G'$, gdzie $G$ jest grupą węzła, jego ilorazem $\mathfrak{Z}_n := \mathfrak{Z} / n\mathfrak {Z}$ oraz faktem, że $(\mathfrak{Z}_a * \mathfrak{Z}_b)'$ jest grupą wolną rzędu $(a-1)(b-1)$.
Patrz też, co pisze Murasugi \cite[s. 149]{murasugi1996}.
