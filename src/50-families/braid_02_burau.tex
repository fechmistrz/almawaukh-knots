...
Magnus, Peluso \cite{magnus1969} pokazali to samo dla $n = 3$, ale ich pracę czyta się tak trudno, że polecamy sięgnąć raczej po to, co napisała Birman \cite[s. 129]{birman1974} albo Kassel, Turajew \cite[s. 110]{kassel2008}.
...
Ich konstrukcja korzysta z~pewnej zamkniętej krzywej na sześciokrotnie przekłutym dysku o~pewnych cechach homologicznych.
...
Część informacji ukradliśmy z artykułu ,,Burau representation'' \url{https://w.wiki/7Wpz}, inne można znaleźć u Burdego, Zieschanga \cite[s. 181]{burde2014}.
