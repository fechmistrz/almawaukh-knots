...
\index{genus!kanoniczny}%
    ...
    Najmniejszy z genusów powierzchni Seiferta węzła $K$, które pochodzą z~algorytmu Seiferta, nazywamy genusem kanonicznym i~oznaczamy symbolem $\operatorname{g_c} K$ lub krótko $g_c$.
\end{definition}
...
% DICTIONARY;handlebody;ciało z rączkami;-
...
(O ciałach z rączkami piszą Burde, Zieschang \cite[s. 44-48]{burde2014}).
