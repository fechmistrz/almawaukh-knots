...
\end{comment}
\noindent
    Oto mnemotechnika ułatwiająca zapamiętywanie relacji.
...
Burde, Zieschang \cite[s. 180]{burde2014} podają przykład, dlaczego dla $n = 2$ to nie jest wystarczające: dla grupy $G$ generowanej przez $x, y$ z relacją $x^2y = yx$ jakobian nie jest symetryczny.
