...
My poznamy wariant niezmiennika Arfa dla węzłów.
...
\begin{proof}
    Wynika to z~faktów \ref{prp:arf_jones} oraz \ref{prp:jones_multiplicative_2} % , ale bezpośredni dowód też istnieje. akomentowane, bo jednak nie wiem, gdzie
\end{proof}
