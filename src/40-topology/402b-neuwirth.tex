...
Tezę można wzmocnić, szczególnie jeśli znamy twierdzenie Gruszko (o~randze wolnego produktu):
% https://www.mathnet.ru/php/archive.phtml?wshow=paper&jrnid=sm&paperid=6023&option_lang=rus
% О базисах свободного произведения групп
\index{twierdzenie Gruszko o randze wolnego produktu}

\begin{proposition}
\index{suma spójna}%
    Suma węzłów $K_1 \shrap K_2$ jest rozwłókniona wtedy i tylko wtedy, gdy obydwa składniki takie są.
\end{proposition}

\begin{proof}[Niedowód]
    U Burdego, Zieschange \cite[s. 107]{burde2014}.
\end{proof}
