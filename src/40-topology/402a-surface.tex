...
Istnieje ogólniejsze pojęcie, to jest rozmaitość z~brzegiem: każdy jej punkt posiada otoczenie homeomorficzne z otwartym podzbiorem górnej półpłaszczyzny $\{x \in \C: \mathfrak{Im}(x) \ge 0\}$.
...
\end{comment}
    ...
    Pozostało wskazać orientację dla tak otrzymanej powierzchni.
