...
Poniżej znajdują się diagramy splotów pierwszych, które realizują liczbę skrzyżowań, jeśli ta nie przekracza dziewięciu.
Pochodzą one z~bazy danych LinkInfo \cite{linkinfo24}, siostrzanego projektu KnotInfo (o~którym mowa na początku rozdziału) prowadzonego przez tych samych autorów -- Charlesa Livingstona oraz Allison Moore -- tym razem poświęconego splotom, a~nie tylko węzłom.
