...
Wiele pytań w~teorii węzłów wciąż czeka na odpowiedź, a~część z~nich zebrał Robion Kirby w~kolejnych listach problemów topologii niskowymiarowej: pierwsza ukazała się w~latach 1976--1978, druga (zwana K2) w~1997 roku \cite{kirby1997}, a~jej wcześniejszą wersję dostępną w~sieci cytujemy jako \cite{kirby1978}.
Trzecią listę, K3, przygotowali niedawno Baykur, Kirby i~Ruberman \cite{baykur2026}.
\index[persons]{Kirby, Rob}%
\index[persons]{Baykur, Inanc}%
\index[persons]{Ruberman, Daniel}%
Tam, gdzie hipoteza opisana w~tej książce znajduje się na którejś z~tych list i~wiemy, co się z~nią stało od czasu K2, dopisujemy to w~tekście.
