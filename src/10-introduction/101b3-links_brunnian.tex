...
Jest niemożliwym, by wykonać model przestrzenny tego splotu przy użyciu okrągłych pierścieni (Freedman i Skora \cite[lemat 3.2]{freedman1987} w pracy o ,,dziwnych akcjach grup na sferach'', używając czterowymiarowej geometrii hiperbolicznej).
\index[persons]{Freedman, Michael}%
\index[persons]{Skora, Richard}%
Zamiast tego można użyć na przykład elips o~dowolnie małej mimośrodowości (Gunn, Sullivan \cite{gunn2008}).
\index[persons]{Gunn, Charles}%
\index[persons]{Sullivan, John}%
Ci sami autorzy pokazali też, że pierścienie Boromeuszy można zrealizować za pomocą trzech wzajemnie prostopadłych złotych prostokątów, osadzonych wzdłuż trzech par przeciwległych krawędzi regularnego dwudziestościanu.

Coxeter w 1993 roku przedstawił pewne zadanie, które rozwiązali Burgiel, Franzblau, Gutschera \cite{burgiel1996}.
Z ich artykułu wynika, że liczba patykowa pierścieni Boromeuszy wynosi 9.
\index[persons]{Burgiel, Heidi}%
\index[persons]{Franzblau, Deborah}%
\index[persons]{Gutschera, Kevin}%
