...
\index{notacja!Gaußa|(}%
Pierwszymi osobami, które zajmowały się węzłami, byli prawdopodobnie Gauß oraz jego uczeń, Listing.
...
Do opisu węzła używa się dwóch liczb: jego indeksu skrzyżowaniowego z dolnym indeksem, oznaczającym miejsce w tablicy~węzłów.
