...
\begin{remark}[Kurt Werner Friedrich Reidemeister]
    ...
    % o soczewkowych piszą Burde, Zieschang na s. 158; zrobił to z W. Franzem
...
Znamy też dolne ograniczenie: Hass, Nowik \cite{hass2010} skonstruowali dla każdej liczby naturalnej $n$ diagram niewęzła o~$7n - 1$ skrzyżowaniach, do którego sprowadzenia do diagramu trywialnego potrzeba co najmniej $2n^2 + 3n - 2$ ruchów Reidemeistera.
\index[persons]{Hass, Joel}%
\index[persons]{Nowik, Tahl}%
Liczba ruchów rośnie więc kwadratowo względem liczby skrzyżowań.
Nie wiadomo, czy dla wszystkich węzłów istnieje wielomianowa górna granica \cite[problem 1.77]{baykur2026}.
