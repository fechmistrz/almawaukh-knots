...
\index{węzeł!alternujący}%
    ...
    Splot $L$ jest alternujący, jeśli posiada alternujący diagram $D$.
\end{definition}
...
Mimo braku zwartego wzoru, dokładne wartości $a_n$ są znane i~stablicowane aż do $n = 24$ (ciąg \href{https://oeis.org/A002864}{A002864} w OEIS).
