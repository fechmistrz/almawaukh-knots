...
\label{def:fox_derivative}%
    ...
    \begin{align}
        ...
        \forall u, v \in G : \frac{\partial}{\partial g_i} (uv) & = \frac{\partial}{\partial g_i}(u) + u \frac{\partial}{\partial g_i} (v),
    \end{align}
    gdzie $\delta_{ij}$ oznacza deltę Kroneckera, nazywamy pochodną cząstkową Foxa.
\end{definition}

Ustalmy grupę $G$ oraz jej prezentację $\langle X | R \rangle = F/N$, gdzie $F = \langle X \rangle$ jest wolną grupą, zaś $N$ to domknięcie normalne relacji $R$.
...
Wolnemu rachunkowi różniczkowemu poświęcony jest rozdział 9 książki Burdego, Zieschange'a \cite[s. 140-160]{burde2014}.
