...
\begin{proposition}
    $\jones_L(\omega_6) = \pm i^{n-1} \cdot (\sqrt 3i)^r$, gdzie $r$ jest rangą pierwszej grupy homologii podwójnego rozgałęzionego nakrycia $L$ nad $\Z/3\Z$.
\end{proposition}

Przytycki \cite[s. 200]{przytycki1995} pisze, że $\tau_3 L = 3 |\jones_L^2 (\omega_6)|$.
...
\begin{proposition}
    Niech $L$ będzie splotem z podwójnym nakryciem $p$ sfery rozgałęzionym nad ogniwami $L$, zaś $H_1$ pierwszą grupą homlologii $p$.
