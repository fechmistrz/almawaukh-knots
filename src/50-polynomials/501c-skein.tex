...
Jednocześnie nie znamy się na robieniu na drutach, więc może nie popełniamy zbrodni mówiąc o~kłębach zamiast o~motkach.
...
Na nowo odkrył go Conway: chcąc szybko liczyć wielomian Alexandera zaproponował, by reparametryzować go wzorem $\alexander(x^2) = \conway(x - 1/x)$; z tego względu funkcję $\conway$ nazywa się czasem potencjałem Conwaya (robią tak Burde, Zieschang \cite[s. 152]{burde2014}).
...
Burde, Zieschang \cite[s. 150]{burde2014} wyprowadzają to z prezentacji Wirtingera.
