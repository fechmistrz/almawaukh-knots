...
\begin{proposition}
    Istnieje nieskończenie wiele węzłów dwumostowych genusu $g > 0$ i nieskończenie wiele rozwłóknionych węzłów dwumostowych, ale (dla ustalonego $g$) tylko skończenie wiele rozwłóknionych węzłów dwumostowych genusu $g$.
\end{proposition}
