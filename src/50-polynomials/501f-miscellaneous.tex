...
Które wielomiany wielu zmiennych są wielomianami Alexandera splotów, nie wiadomo; nawet dla splotów dwuogniwowych nie znamy pełnej charakteryzacji, chociaż Bailey \cite{bailey1977} opisał ich moduły Alexandera \cite[problem 1.8]{baykur2026}.
\index[persons]{Bailey, James}%
W~szczególnych klasach wiemy więcej: Koseleff, Pecker \cite{koseleff2015} podali kolejne warunki konieczne (wciąż niewystarczające) dla splotów dwumostowych, a~Hoste \cite{hoste2020} znalazł algorytm, który dla wielomianu dwóch zmiennych rozstrzyga, czy jest on wielomianem Alexandera dwuogniwowego splotu dwumostowego.
...
% DICTIONARY;log-concave;logarytmicznie wklęsły;-
% DICTIONARY;special alternating;specjalnie alternujący;splot
